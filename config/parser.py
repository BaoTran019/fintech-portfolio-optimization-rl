...
def get_parser():
    ...
    parser.add_argument('--train_end', type=str, default='2021-12-31', help='Training split end date (YYYY-MM-DD)')
    parser.add_argument('--val_start', type=str, default='2022-01-01', help='Validation split start date (YYYY-MM-DD)')
    parser.add_argument('--val_end', type=str, default='2023-12-31', help='Validation split end date (YYYY-MM-DD)')
